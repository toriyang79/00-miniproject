...
POST   /api/prompts/{id}/apply\_variables/  - 변수 대체 실행
...
POST /api/prompts/1/apply\_variables/
...
이 README는 포트폴리오로도 충분히 활용 가능해요.

깃허브에 업로드 후 상단에 “Deploy” 배지나 “Demo 영상” 링크만 추가하면 완성입니다 🎯
